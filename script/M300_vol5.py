...
Script pour Vol du polar 6 No: 5
"""
...
m300 = open("/Users/ludovick/Desktop/data_netcare/M300csv/sc5_20150409_M300.csv")
heiko = open("/Users/ludovick/Desktop/data_netcare/Heiko/Flight5_H2O.csv")
...
i1,i2 = searchsorted(dates,[datetime(2015,4,9,14,05),datetime(2015,4,9,17,04)])   #ascent     
