...
Script pour Vol du polar 6 No: 7
"""
...
m300 = open("/Users/ludovick/Desktop/data_netcare/M300csv/sc7_20150413_M300.csv")
heiko = open("/Users/ludovick/Desktop/data_netcare/Heiko/Flight7_H2O.csv")
...
i1,i2 = searchsorted(dates,[datetime(2015,4,13,17,22),datetime(2015,4,13,19,18)])   #ascent     
...
#-Clean data     
rhi = ma.masked_greater(rhi[i1:i2],1.5)
...
part = ma.masked_greater(part[i1:i2],10) 
