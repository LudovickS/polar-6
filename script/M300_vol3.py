...
Script pour Vol du polar 6 No: 4
"""
...
m300 = open("/Users/ludovick/Desktop/data_netcare/M300csv/sc3_20150408_M300.csv")
heiko = open("/Users/ludovick/Desktop/data_netcare/Heiko/Flight3_H2O.csv")
...
i1,i2 = searchsorted(dates,[datetime(2015,4,8,14,40),datetime(2015,4,8,15,42)])   #ascent     
